  ...
  return (
    <div className="space-y-8 py-4">
      ...
      <div className="space-y-2 text-center">
        ...
        <h2 className="text-foreground text-2xl font-bold">Tes médicaments</h2>
        <p className="text-muted-foreground">
          Ajoute ton traitement pour suivre tes prises et ton stock
        </p>
      </div>
      ...
      <div className="space-y-3 text-left">
        <div className="bg-muted/30 flex items-center gap-3 rounded-lg p-3">
          ...
          <span className="text-foreground text-sm">Rappels de prise</span>
        </div>
        <div className="bg-muted/30 flex items-center gap-3 rounded-lg p-3">
          <div className="bg-secondary h-2 w-2 rounded-full" />
          <span className="text-foreground text-sm">Suivi du stock avec alertes</span>
        </div>
        <div className="bg-muted/30 flex items-center gap-3 rounded-lg p-3">
          <div className="h-2 w-2 rounded-full bg-green-500" />
          <span className="text-foreground text-sm">Historique des changements de traitement</span>
        </div>
        <div className="bg-muted/30 flex items-center gap-3 rounded-lg p-3">
          <div className="h-2 w-2 rounded-full bg-yellow-500" />
          <span className="text-foreground text-sm">Calendrier des prises</span>
        </div>
      </div>
      ...
      <p className="text-muted-foreground text-center text-xs">
        Tu pourras toujours ajouter des médicaments depuis le menu Médicaments
      </p>
    </div>
  )
}
